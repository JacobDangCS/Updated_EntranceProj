...
let firstPage = [
  {
    welcome: "<div class='intro1-container intro'> Welcome to Jake’s Film Curations! </div>" +
      "<br>" + "<div class='intro2-container intro'> I’m Jacob Dang and am an avid movie watcher! </div>" +
      "<br>" + "<div class='intro3-container intro'> Can’t figure out what to watch? Then go through this thorough questionnaire to decide on tonight’s film of my choice! </div>" +
      "<br>"
  }
];
...
function openTitle() {
  ...
  test.innerHTML = "<h2 class='intro'>" + introPage + "</h2>";
  test.innerHTML += "<br> <label class='intro'> <button onclick='firstQuestion()'>Next</button> </label> <label class='intro'> <button onclick='interestedPage()' id='intBtn'>Your Interested</button> </label>";
}
...
function interestedPage() {
  ...
  if (userSaved.length == 0 || userSaved == null) {
    ...
    let allTitle = document.querySelectorAll('.intro')
...
let data = [{
  "Title": "<h2> <p class='title-container'> Spiderman: Into the Spider-verse </p> </h2>",
  "Genre": "Action",
  "animated": true,
  ...
  "Title": "<h2> <p class='title-container'> Howl's Moving Castle </p> </h2>",
  "Genre": "Adventure",
  "animated": true,
...
{
  "Title": "<h2> <p class='title-container'> Mitchells V.S The Machines </p> </h2>",
  "Genre": "Comedy",
  "animated": true,
...
{
  "Title": "<h2> <p class='title-container'>Your Name</p> </h2>",
  "Genre": "Romance",
  "animated": true,
  ...
  "Title": "<h2> <p class='title-container'> Spirited Away </p> </h2>",
  "Genre": "Coming of Age",
  "animated": true,
  ...
  "Title": "<h2> <p class='title-container'> Coraline </p> </h2>",
  "Genre": "Horror",
  "animated": true,
  ...
  "Title": "<h2> <p class='title-container'> The Departed </p> </h2>",
  "Genre": "Action",
  "animated": false,
  ...
  "Title": "<h2> <p class='title-container'> Kung Fu Hustle </p> </h2>",
  "Genre": "Adventure",
  "animated": false,
  ...
  "Title": "<h2> <p class='title-container'> Superbad </p> </h2>",
  "Genre": "Comedy",
  "animated": false,
  ...
  "Title": "<h2> <p class='title-container'> Moonlight </p> </h2>",
  "Genre": "Romance",
  "animated": false,
  ...
  "Title": "<h2> <p class='title-container'> Mid90s </p> </h2>",
  "Genre": "Coming of Age",
  "animated": false,
  ...
  "Title": "<h2> <p class='title-container'> Annihilation </p> </h2>",
  "Genre": "Horror",
  "animated": false,
